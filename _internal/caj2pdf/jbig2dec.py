...
if (arch[1] == 'WindowsPE'):
    if (arch[0] == '64bit'):
        libjbig2codec = cdll.LoadLibrary("C:/Users/LIYNTL/caj2pdf/lib/bin/libjbig2codec-w64.dll")
    else:
        libjbig2codec = cdll.LoadLibrary("C:/Users/LIYNTL/caj2pdf/lib/bin/libjbig2codec-w32.dll")
else:
